 ...
 * @author Rob Cernich
 */
public class ApplicationNode extends ContentNode<ApplicationsNode> {

    /**
     * Create a new ApplicationNode.
     * 
     * @param container the parent
     * @param name the application name
     */
    public ApplicationNode(ApplicationsNode container, String name) {
