 ...
 * 
 */
public class CamelXMLImplementationPropertySectionFilter extends AbstractPropertySectionFilter {

    @Override
    protected boolean accept(PictogramElement pe) {
        EObject bo = Graphiti.getLinkService().getBusinessObjectForLinkedPictogramElement(pe);
        return bo instanceof Component && ((Component) bo).getImplementation() instanceof CamelImplementationType
                && ((CamelImplementationType) ((Component) bo).getImplementation()).getXml() != null;
    }
}
