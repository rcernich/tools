 ...
 * 
 */
public class RulesEventListenerTable extends Composite implements ICellModifier {
     ...
     */
    public RulesEventListenerTable(Composite parent, int style) {
     ...
     */
    public RulesEventListenerTable(Composite parent, int style, boolean isReadOnly) {
        super(parent, style);
        ...
        _propertyTreeTable.setCellEditors(new CellEditor[] {new ClassDialogCellEditor(_propertyTreeTable.getTable(),
                "java.util.EventListener", Messages.label_eventListener, Messages.tooltip_selectEventListener) { //$NON-NLS-1$
            ...
            if (impl.eContainer() != null) {
                ...
                domain.getCommandStack().execute(new RecordingCommand(domain) {
                    ...
                    protected void doExecute() {
                        ListenerType newAction = RulesFactory.eINSTANCE.createListenerType();
                        newAction.setClass("classname"); //$NON-NLS-1$
                        if (impl.getListeners() == null) {
                            impl.setListeners(RulesFactory.eINSTANCE.createListenersType());
                        }
