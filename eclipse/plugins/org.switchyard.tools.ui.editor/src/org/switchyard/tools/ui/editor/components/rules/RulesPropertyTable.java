 ...
 * 
 */
public class RulesPropertyTable extends Composite implements ICellModifier {
     ...
     */
    public RulesPropertyTable(Composite parent, int style) {
     ...
     */
    public RulesPropertyTable(Composite parent, int style, boolean isReadOnly) {
        super(parent, style);
                ...
                domain.getCommandStack().execute(new RecordingCommand(domain) {
                    ...
                    protected void doExecute() {
                        if (impl.getProperties() == null) {
                            impl.setProperties(RulesFactory.eINSTANCE.createPropertiesType());
                        }
