...
public class CamelFTPConsumerComposite extends AbstractSYBindingComposite {
    ...
    CamelFTPConsumerComposite(FormToolkit toolkit) {
        super(toolkit);
    }
    ...
    private Control getConsumerTabControl(Composite tabFolder) {
        ...
        _opSelectorComposite.setLayout(layout);
   ...
   protected void handleModify(Control control) {
    ...
    private void bindControls(final DataBindingContext context) {
        ...
        org.eclipse.core.databinding.Binding binding = context.bindValue(
                ...
                new EMFUpdateValueStrategyNullForEmptyString(null, UpdateValueStrategy.POLICY_CONVERT)
                        .setAfterConvertValidator(new StringEmptyValidator(
                                "FTP binding name cannot be empty")), null);
        ...
        binding = context.bindValue(SWTObservables.observeText(_nameText, new int[] {SWT.Modify }), ObservablesUtil
                ...
                new EMFUpdateValueStrategyNullForEmptyString(null, UpdateValueStrategy.POLICY_CONVERT)
                        .setAfterConvertValidator(new StringEmptyValidator(
                                "FTP binding name cannot be empty")), new UpdateValueStrategy(
