 ...
 * IComponentService
 * 
 * Represents SCA component service element.
 * 
 * @author Rob Cernich
 */
@GenerateImpl
public interface IComponentService extends IModelElement {
    ...
    @Type(base = IComponentServiceInterface.class)
    @XmlElementBinding(mappings = {@XmlElementBinding.Mapping(element = ComponentServiceInterfaceModel.INTERFACE, type = IComponentServiceInterface.class) })
     ...
     */
    ModelElementHandle<IComponentServiceInterface> getInterfaze();
