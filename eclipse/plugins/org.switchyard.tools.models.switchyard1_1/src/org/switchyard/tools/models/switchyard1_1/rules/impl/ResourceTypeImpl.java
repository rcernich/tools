 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.rules.impl.ResourceTypeImpl#getResourceDetail <em>Resource Detail</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.rules.impl.ResourceTypeImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.rules.impl.ResourceTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceTypeImpl extends CommonExtensionBaseImpl implements ResourceType {
	...
	protected EClass eStaticClass() {
        return RulesPackage.Literals.RESOURCE_TYPE;
    }
    ...
    public NotificationChain basicSetResourceDetail(ResourceDetailType newResourceDetail, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RulesPackage.RESOURCE_TYPE__RESOURCE_DETAIL, oldResourceDetail, newResourceDetail);
    ...
    public void setResourceDetail(ResourceDetailType newResourceDetail) {
        if (newResourceDetail != resourceDetail) {
            ...
            if (resourceDetail != null)
                msgs = ((InternalEObject)resourceDetail).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RulesPackage.RESOURCE_TYPE__RESOURCE_DETAIL, null, msgs);
            if (newResourceDetail != null)
                msgs = ((InternalEObject)newResourceDetail).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RulesPackage.RESOURCE_TYPE__RESOURCE_DETAIL, null, msgs);
            msgs = basicSetResourceDetail(newResourceDetail, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.RESOURCE_TYPE__RESOURCE_DETAIL, newResourceDetail, newResourceDetail));
    }
    ...
    public void setLocation(String newLocation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.RESOURCE_TYPE__LOCATION, oldLocation, location));
    }
    ...
    public void setType(String newType) {
        ...
        type = newType;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.RESOURCE_TYPE__TYPE, oldType, type));
    }
