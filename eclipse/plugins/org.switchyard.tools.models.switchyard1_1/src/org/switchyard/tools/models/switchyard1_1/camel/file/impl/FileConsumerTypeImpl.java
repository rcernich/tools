/**
 */
package org.switchyard.tools.models.switchyard1_1.camel.file.impl;

import org.eclipse.emf.common.notify.Notification;
import org.eclipse.emf.ecore.EClass;
import org.eclipse.emf.ecore.impl.ENotificationImpl;
import org.eclipse.emf.ecore.impl.EObjectImpl;
import org.switchyard.tools.models.switchyard1_1.camel.file.FileConsumerType;
import org.switchyard.tools.models.switchyard1_1.camel.file.FilePackage;
import org.switchyard.tools.models.switchyard1_1.camel.file.TimeUnitType;
 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getInitialDelay <em>Initial Delay</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#isUseFixedDelay <em>Use Fixed Delay</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#isSendEmptyMessageWhenIdle <em>Send Empty Message When Idle</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getTimeUnit <em>Time Unit</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getMaxMessagesPerPoll <em>Max Messages Per Poll</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#isDelete <em>Delete</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#isRecursive <em>Recursive</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#isNoop <em>Noop</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getPreMove <em>Pre Move</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getMove <em>Move</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getMoveFailed <em>Move Failed</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getInclude <em>Include</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getExclude <em>Exclude</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#isIdempotent <em>Idempotent</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getIdempotentRepository <em>Idempotent Repository</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getInProgressRepository <em>In Progress Repository</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getSorter <em>Sorter</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getSortBy <em>Sort By</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getReadLock <em>Read Lock</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getReadLockTimeout <em>Read Lock Timeout</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getReadLockCheckInterval <em>Read Lock Check Interval</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getExclusiveReadLockStrategy <em>Exclusive Read Lock Strategy</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getProcessStrategy <em>Process Strategy</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#isStartingDirectoryMustExist <em>Starting Directory Must Exist</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#isDirectoryMustExist <em>Directory Must Exist</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.camel.file.impl.FileConsumerTypeImpl#getDoneFileName <em>Done File Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileConsumerTypeImpl extends EObjectImpl implements FileConsumerType {
     ...
     * @ordered
     */
    protected static final String MOVE_EDEFAULT = "";
    ...
    public void setInitialDelay(Object newInitialDelay) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__INITIAL_DELAY, oldInitialDelay, initialDelay, !oldInitialDelayESet));
    }
    ...
    public void unsetInitialDelay() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, FilePackage.FILE_CONSUMER_TYPE__INITIAL_DELAY, oldInitialDelay, INITIAL_DELAY_EDEFAULT, oldInitialDelayESet));
    }
    ...
    public void setDelay(Object newDelay) {
        ...
        delayESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__DELAY, oldDelay, delay, !oldDelayESet));
    }
    ...
    public void unsetDelay() {
        ...
        delayESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, FilePackage.FILE_CONSUMER_TYPE__DELAY, oldDelay, DELAY_EDEFAULT, oldDelayESet));
    }
    ...
    public void setMaxMessagesPerPoll(Object newMaxMessagesPerPoll) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__MAX_MESSAGES_PER_POLL, oldMaxMessagesPerPoll, maxMessagesPerPoll, !oldMaxMessagesPerPollESet));
    }
    ...
    public void unsetMaxMessagesPerPoll() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, FilePackage.FILE_CONSUMER_TYPE__MAX_MESSAGES_PER_POLL, oldMaxMessagesPerPoll, MAX_MESSAGES_PER_POLL_EDEFAULT, oldMaxMessagesPerPollESet));
    }
    ...
    public void setInclude(String newInclude) {
        ...
        include = newInclude;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__INCLUDE, oldInclude, include));
    }
    ...
    public void setExclude(String newExclude) {
        ...
        exclude = newExclude;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__EXCLUDE, oldExclude, exclude));
    }
    ...
    public void setIdempotentRepository(String newIdempotentRepository) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__IDEMPOTENT_REPOSITORY, oldIdempotentRepository, idempotentRepository));
    }
    ...
    public void setInProgressRepository(String newInProgressRepository) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__IN_PROGRESS_REPOSITORY, oldInProgressRepository, inProgressRepository));
    }
    ...
    public void setFilter(String newFilter) {
        ...
        filter = newFilter;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__FILTER, oldFilter, filter));
    }
    ...
    public void setSorter(String newSorter) {
        ...
        sorter = newSorter;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__SORTER, oldSorter, sorter));
    }
    ...
    public void setSortBy(String newSortBy) {
        ...
        sortBy = newSortBy;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__SORT_BY, oldSortBy, sortBy));
    }
    ...
    public void setReadLock(String newReadLock) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__READ_LOCK, oldReadLock, readLock));
    }
    ...
    public void setExclusiveReadLockStrategy(String newExclusiveReadLockStrategy) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__EXCLUSIVE_READ_LOCK_STRATEGY, oldExclusiveReadLockStrategy, exclusiveReadLockStrategy));
    }
    ...
    public void setProcessStrategy(String newProcessStrategy) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__PROCESS_STRATEGY, oldProcessStrategy, processStrategy));
    }
    ...
    public void setDoneFileName(String newDoneFileName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.FILE_CONSUMER_TYPE__DONE_FILE_NAME, oldDoneFileName, doneFileName));
    }
