 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.rules.impl.ChannelsTypeImpl#getChannel <em>Channel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChannelsTypeImpl extends CommonExtensionBaseImpl implements ChannelsType {
    ...
    protected EClass eStaticClass() {
        return RulesPackage.Literals.CHANNELS_TYPE;
    }
    ...
    public EList<ChannelType> getChannel() {
        if (channel == null) {
            channel = new EObjectContainmentEList<ChannelType>(ChannelType.class, this, RulesPackage.CHANNELS_TYPE__CHANNEL);
        }
        return channel;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case RulesPackage.CHANNELS_TYPE__CHANNEL:
