 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.rules.impl.FaultsTypeImpl#getFault <em>Fault</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FaultsTypeImpl extends CommonExtensionBaseImpl implements FaultsType {
    ...
    protected EClass eStaticClass() {
        return RulesPackage.Literals.FAULTS_TYPE;
    }
    ...
    public EList<MappingType> getFault() {
        if (fault == null) {
            fault = new EObjectContainmentEList<MappingType>(MappingType.class, this, RulesPackage.FAULTS_TYPE__FAULT);
        }
        return fault;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case RulesPackage.FAULTS_TYPE__FAULT:
