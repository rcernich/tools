 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.bpm.impl.LoggersTypeImpl#getLogger <em>Logger</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LoggersTypeImpl extends CommonExtensionBaseImpl implements LoggersType {
    ...
    protected EClass eStaticClass() {
        return BPMPackage.Literals.LOGGERS_TYPE;
    }
    ...
    public EList<LoggerType1> getLogger() {
        if (logger == null) {
            logger = new EObjectContainmentEList<LoggerType1>(LoggerType1.class, this, BPMPackage.LOGGERS_TYPE__LOGGER);
        }
        return logger;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case BPMPackage.LOGGERS_TYPE__LOGGER:
