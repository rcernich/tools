 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.bpm.impl.ResourcesTypeImpl#getResource <em>Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourcesTypeImpl extends CommonExtensionBaseImpl implements ResourcesType {
    ...
    protected EClass eStaticClass() {
        return BPMPackage.Literals.RESOURCES_TYPE;
    }
    ...
    public EList<ResourceType> getResource() {
        if (resource == null) {
            resource = new EObjectContainmentEList<ResourceType>(ResourceType.class, this, BPMPackage.RESOURCES_TYPE__RESOURCE);
        }
        return resource;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case BPMPackage.RESOURCES_TYPE__RESOURCE:
