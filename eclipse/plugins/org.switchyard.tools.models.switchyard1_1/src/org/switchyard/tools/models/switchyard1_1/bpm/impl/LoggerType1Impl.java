 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.bpm.impl.LoggerType1Impl#getInterval <em>Interval</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.bpm.impl.LoggerType1Impl#getLog <em>Log</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.bpm.impl.LoggerType1Impl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LoggerType1Impl extends CommonExtensionBaseImpl implements LoggerType1 {
    ...
    protected EClass eStaticClass() {
        return BPMPackage.Literals.LOGGER_TYPE1;
    }
    ...
    public void setInterval(Object newInterval) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BPMPackage.LOGGER_TYPE1__INTERVAL, oldInterval, interval));
    }
    ...
    public void setLog(String newLog) {
        ...
        log = newLog;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BPMPackage.LOGGER_TYPE1__LOG, oldLog, log));
    }
    ...
    public void setType(LoggerType newType) {
        ...
        typeESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BPMPackage.LOGGER_TYPE1__TYPE, oldType, type, !oldTypeESet));
    }
    ...
    public void unsetType() {
        ...
        typeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, BPMPackage.LOGGER_TYPE1__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case BPMPackage.LOGGER_TYPE1__INTERVAL:
                return getInterval();
            case BPMPackage.LOGGER_TYPE1__LOG:
                return getLog();
            case BPMPackage.LOGGER_TYPE1__TYPE:
                return getType();
        }
