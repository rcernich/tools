 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.rules.impl.ResourceDetailTypeImpl#getInputType <em>Input Type</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.rules.impl.ResourceDetailTypeImpl#isUsingExternalTypes <em>Using External Types</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_1.rules.impl.ResourceDetailTypeImpl#getWorksheetName <em>Worksheet Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceDetailTypeImpl extends CommonExtensionBaseImpl implements ResourceDetailType {
    ...
    protected EClass eStaticClass() {
        return RulesPackage.Literals.RESOURCE_DETAIL_TYPE;
    }
    ...
    public void setInputType(String newInputType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.RESOURCE_DETAIL_TYPE__INPUT_TYPE, oldInputType, inputType));
    }
    ...
    public void setUsingExternalTypes(boolean newUsingExternalTypes) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.RESOURCE_DETAIL_TYPE__USING_EXTERNAL_TYPES, oldUsingExternalTypes, usingExternalTypes, !oldUsingExternalTypesESet));
    }
    ...
    public void unsetUsingExternalTypes() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, RulesPackage.RESOURCE_DETAIL_TYPE__USING_EXTERNAL_TYPES, oldUsingExternalTypes, USING_EXTERNAL_TYPES_EDEFAULT, oldUsingExternalTypesESet));
    }
    ...
    public void setWorksheetName(String newWorksheetName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.RESOURCE_DETAIL_TYPE__WORKSHEET_NAME, oldWorksheetName, worksheetName));
    }
