...
public class SCADiagramAddReferenceFeature extends AbstractAddFeature {

	public SCADiagramAddReferenceFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
        ...
        if (addedComponentReference != null)
        	link(connection, addedComponentReference);
