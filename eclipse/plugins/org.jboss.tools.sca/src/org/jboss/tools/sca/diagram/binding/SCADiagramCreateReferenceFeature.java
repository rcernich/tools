...
public class SCADiagramCreateReferenceFeature extends
AbstractCreateConnectionFeature {

	public SCADiagramCreateReferenceFeature(IFeatureProvider fp) {
	...
	public Connection create(ICreateConnectionContext context) {
		...
		if (source instanceof Service && target instanceof Component) {
			...
			if (source != null && target != null) {
				...
				Reference eReference = createReference(src, tgt);
	...
	private Reference createReference(Service source, Component target) {

		Reference eReference = ScaFactory.eINSTANCE.createReference();
//		EObject o = (EObject) eReference;
//		EStructuralFeature f = o.eClass().getEStructuralFeature(ScaPackage.REFERENCE__NAME);
//		o.eSet(f,source.getName());		
	...
	private Reference createReference (Component source, Component target) {
		Reference eReference = ScaFactory.eINSTANCE.createReference();
//		ComponentReference eReference = ScaFactory.eINSTANCE.createComponentReference();
		eReference.setName(source.getName());
		ArrayList<String> targetRef = new ArrayList<String>();
