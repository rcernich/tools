...
public class SCADiagramAddComponentServiceFeature extends AbstractAddShapeFeature {
	...
	public PictogramElement add(IAddContext context) {
		ComponentService addedComponentService = null;
		if (context.getNewObject() instanceof ComponentService) {
			addedComponentService = (ComponentService) context.getNewObject();
		}
		...
		// create service
		{
			...
			if (addedComponentService != null && addedComponentService.eResource() == null) {
				getDiagram().eResource().getContents().add(addedComponentService);
			}


			// create link and wire it
			if (addedComponentService != null) 
				link(containerShape, addedComponentService);
		...
		// SHAPE WITH TEXT
		{
			...
			// create link and wire it
			link(shape, addedComponentService);
		}
