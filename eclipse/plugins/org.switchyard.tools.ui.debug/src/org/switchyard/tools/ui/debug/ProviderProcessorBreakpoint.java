...
/**
 * ProviderProcessorBreakpoint
 * <p/>
 * Breakpoint for SwitchYard PROVIDER_CALLBACK.
 */
public class ProviderProcessorBreakpoint extends CamelProcessorBreakpoint {

    private static final String MARKER_ID = "org.switchyard.tools.ui.debug.switchYardServiceBreakpointMarker";
    private static final String TYPE = "org.switchyard.bus.camel.processors.ProviderProcessor";
    private static final String EXCHANGE_VARIABLE = "ex";

    /**
     * Create a new ProviderProcessorBreakpoint.
     */
    public ProviderProcessorBreakpoint() {
     ...
     */
    public ProviderProcessorBreakpoint(final IResource resource, final IInteractionConfiguration configuration,
