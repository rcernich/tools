...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	/**
	 * The default value of the '{@link #getImplementationBpel() <em>Implementation Bpel</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final Object IMPLEMENTATION_BPEL_EDEFAULT = null;
	 ...
	 * @generated
	 */
	public Object getImplementationBpel() {
		return getMixed().get(BPELPackage.Literals.DOCUMENT_ROOT__IMPLEMENTATION_BPEL, true);
	}
	 ...
	 * @generated
	 */
	public void setImplementationBpel(Object newImplementationBpel) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case BPELPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION:
				...
				return;
			case BPELPackage.DOCUMENT_ROOT__IMPLEMENTATION_BPEL:
				setImplementationBpel(newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case BPELPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION:
				...
				return;
			case BPELPackage.DOCUMENT_ROOT__IMPLEMENTATION_BPEL:
				setImplementationBpel(IMPLEMENTATION_BPEL_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case BPELPackage.DOCUMENT_ROOT__IMPLEMENTATION_BPEL:
				return IMPLEMENTATION_BPEL_EDEFAULT == null ? getImplementationBpel() != null : !IMPLEMENTATION_BPEL_EDEFAULT.equals(getImplementationBpel());
		}
