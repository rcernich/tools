...
public class BPELAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected BPELSwitch<Adapter> modelSwitch =
		new BPELSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.open.oasis.docs.ns.opencsa.sca.bpel.BPELImplementation <em>Implementation</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.open.oasis.docs.ns.opencsa.sca.bpel.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
