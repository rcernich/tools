 ...
 * @generated
 */
public class ClojureSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ClojurePackage.CLOJURE_IMPLEMENTATION_TYPE: {
				ClojureImplementationType clojureImplementationType = (ClojureImplementationType)theEObject;
				T result = caseClojureImplementationType(clojureImplementationType);
				if (result == null) result = caseImplementationType(clojureImplementationType);
				if (result == null) result = caseCommonExtensionBase(clojureImplementationType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ClojurePackage.DOCUMENT_ROOT: {
	 ...
	 * @generated
	 */
	public T caseClojureImplementationType(ClojureImplementationType object) {
		return null;
	}
