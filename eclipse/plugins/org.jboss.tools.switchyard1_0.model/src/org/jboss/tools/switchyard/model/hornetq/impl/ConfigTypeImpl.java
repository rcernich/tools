...
import org.jboss.tools.switchyard.model.hornetq.ConnectorType;
import org.jboss.tools.switchyard.model.hornetq.DiscoveryGroupType;
 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getAckBatchSize <em>Ack Batch Size</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#isAutoGroup <em>Auto Group</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#isBlockOnAcknowledge <em>Block On Acknowledge</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#isBlockOnDurableSend <em>Block On Durable Send</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#isBlockOnNonDurableSend <em>Block On Non Durable Send</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#isCacheLargeMessagesOnConsumer <em>Cache Large Messages On Consumer</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getCallTimeout <em>Call Timeout</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getClientFailureCheckPeriod <em>Client Failure Check Period</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#isCompressLargeMessages <em>Compress Large Messages</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getConnectionLoadBalancingPolicyClassName <em>Connection Load Balancing Policy Class Name</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getConnectionTTL <em>Connection TTL</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getConfirmationWindowSize <em>Confirmation Window Size</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getConnector <em>Connector</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getConsumerMaxRate <em>Consumer Max Rate</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getConsumerWindowSize <em>Consumer Window Size</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#isDisableFinalizeCheck <em>Disable Finalize Check</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getDiscoveryGroup <em>Discovery Group</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#isFailoverOnInitialConnection <em>Failover On Initial Connection</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getGroupID <em>Group ID</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getInitialMessagePacketSize <em>Initial Message Packet Size</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getInitialReconnectAttempts <em>Initial Reconnect Attempts</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getMaxRetryInterval <em>Max Retry Interval</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getMinLargeMessageSize <em>Min Large Message Size</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#isPreAcknowledge <em>Pre Acknowledge</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getProducerMaxRate <em>Producer Max Rate</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getProducerWindowSize <em>Producer Window Size</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getQueue <em>Queue</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getReconnectAttempts <em>Reconnect Attempts</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getRetryInterval <em>Retry Interval</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getRetryIntervalMultiplier <em>Retry Interval Multiplier</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getScheduledThreadPoolMaxSize <em>Scheduled Thread Pool Max Size</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#getThreadPoolMaxSize <em>Thread Pool Max Size</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#isUseGlobalPools <em>Use Global Pools</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#isUseHA <em>Use HA</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.hornetq.impl.ConfigTypeImpl#isXaSession <em>Xa Session</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
