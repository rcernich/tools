...
public class HornetQSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case HornetQPackage.OPERATION_SELECTOR_TYPE: {
                ...
                if (result == null) result = caseSca_OperationSelectorType(operationSelectorType);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
     ...
     * @generated
     */
    public T caseSca_OperationSelectorType(org.eclipse.soa.sca.sca1_1.model.sca.OperationSelectorType object) {
        return null;
    }
