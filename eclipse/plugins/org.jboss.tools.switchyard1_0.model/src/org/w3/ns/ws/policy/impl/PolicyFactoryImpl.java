...
public class PolicyFactoryImpl extends EFactoryImpl implements PolicyFactory {
	...
	public static PolicyFactory init() {
		try {
			PolicyFactory thePolicyFactory = (PolicyFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.w3.org/ns/ws-policy"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case PolicyPackage.URI_TYPE: return createURIType();
			default:
