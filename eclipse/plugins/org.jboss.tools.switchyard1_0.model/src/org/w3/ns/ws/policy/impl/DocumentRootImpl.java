 ...
 * <ul>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#getAll <em>All</em>}</li>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#getAppliesTo <em>Applies To</em>}</li>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#getExactlyOne <em>Exactly One</em>}</li>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#getPolicy <em>Policy</em>}</li>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#getPolicyAttachment <em>Policy Attachment</em>}</li>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#getPolicyReference <em>Policy Reference</em>}</li>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#getURI <em>URI</em>}</li>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#isIgnorable <em>Ignorable</em>}</li>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#isOptional <em>Optional</em>}</li>
 *   <li>{@link org.w3.ns.ws.policy.impl.DocumentRootImpl#getPolicyURIs <em>Policy UR Is</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	public URIType getURI() {
		return (URIType)getMixed().get(PolicyPackage.Literals.DOCUMENT_ROOT__URI, true);
	}
	...
	public NotificationChain basicSetURI(URIType newURI, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(PolicyPackage.Literals.DOCUMENT_ROOT__URI, newURI, msgs);
	}
	...
	public void setURI(URIType newURI) {
		((FeatureMap.Internal)getMixed()).set(PolicyPackage.Literals.DOCUMENT_ROOT__URI, newURI);
	}
	...
	public void setIgnorable(boolean newIgnorable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PolicyPackage.DOCUMENT_ROOT__IGNORABLE, oldIgnorable, ignorable, !oldIgnorableESet));
	}
	...
	public void unsetIgnorable() {
		...
		ignorableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PolicyPackage.DOCUMENT_ROOT__IGNORABLE, oldIgnorable, IGNORABLE_EDEFAULT, oldIgnorableESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case PolicyPackage.DOCUMENT_ROOT__URI:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PolicyPackage.DOCUMENT_ROOT__URI:
				return getURI();
			case PolicyPackage.DOCUMENT_ROOT__IGNORABLE:
				return isIgnorable();
